  ...
  class ContactPayloadContact
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Cfchat::ContactPayloadContact` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Cfchat::ContactPayloadContact`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'contact_inboxes')
        if (value = attributes[:'contact_inboxes']).is_a?(Array)
          self.contact_inboxes = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          contact_inboxes == o.contact_inboxes
    end
    ...
    def hash
      [email, name, phone_number, thumbnail, additional_attributes, custom_attributes, contact_inboxes].hash
    end
