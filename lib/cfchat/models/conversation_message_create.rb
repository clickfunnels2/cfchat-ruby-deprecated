  ...
  class ConversationMessageCreate
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Cfchat::ConversationMessageCreate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Cfchat::ConversationMessageCreate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      message_type_validator = EnumAttributeValidator.new('String', ["outgoing", "incoming"])
      return false unless message_type_validator.valid?(@message_type)
      content_type_validator = EnumAttributeValidator.new('String', ["input_email", "cards", "input_select", "form", "article"])
    ...
    def message_type=(message_type)
      validator = EnumAttributeValidator.new('String', ["outgoing", "incoming"])
    ...
    def content_type=(content_type)
      validator = EnumAttributeValidator.new('String', ["input_email", "cards", "input_select", "form", "article"])
    ...
    def hash
      [content, message_type, private, content_type, content_attributes].hash
    end
