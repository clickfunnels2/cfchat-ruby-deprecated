...
# Unit tests for Cfchat::Agent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Cfchat::Agent do
  let(:instance) { Cfchat::Agent.new }

  describe 'test an instance of Agent' do
    it 'should create an instance of Agent' do
      expect(instance).to be_instance_of(Cfchat::Agent)
    end
  end
  ...
  describe 'test attribute "available_name"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
