...
# Unit tests for Cfchat::ConversationList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Cfchat::ConversationList do
  let(:instance) { Cfchat::ConversationList.new }

  describe 'test an instance of ConversationList' do
    it 'should create an instance of ConversationList' do
      expect(instance).to be_instance_of(Cfchat::ConversationList)
    end
  end
